...
def add_gitignore(gitginore_template):
	...
	if not gitginore_template == "None":
		url = "https://raw.githubusercontent.com/github/gitignore/master/"+gitginore_template
		gitginore_template = "s" + ".gitignore"
		print(gitginore_template)
		dowonload  = requests.get(url + gitginore_template)
...
def init():
	...
	print(answers.get("readme_confirm"))
	...
	try:
		...
		click.echo(Fore.RED+Style.BRIGHT+"Error : github token not found use set-token command to set your token")
